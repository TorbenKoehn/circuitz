...
export default class Microcontroller extends Circuit {
    ...
    draw(args) {
        ...
        codeLines.forEach((line, index) => {
            ...
            context.fillText(line, bounds.x + 2 * args.gridSize, bounds.y + args.gridSize + index * 12);
        });
        // Draw registers
        context.fillStyle = 'white';
        context.fillText(`acc: ${this.registers.acc}`, bounds.x + 6 * args.gridSize, bounds.y + args.gridSize + 12);
        context.fillText(`isp: ${this.registers.isp}`, bounds.x + 6 * args.gridSize, bounds.y + args.gridSize + 24);
        const flags = ['Z', 'S']
            .map((flag, index) => (this.registers.flg & Math.pow(2, index)) === Math.pow(2, index)
            ? flag
            : '-')
            .join('');
        context.fillText(`flg: ${flags}`, bounds.x + 6 * args.gridSize, bounds.y + args.gridSize + 36);
        context.fillText(`slp: ${this.registers.slp}`, bounds.x + 6 * args.gridSize, bounds.y + args.gridSize + 48);
        // Draw port names next to ports
        context.fillStyle = 'white';
        context.fillText('p0', bounds.x + args.gridSize + 2, bounds.y + args.gridSize - 14);
        context.fillText('p1', bounds.x + args.gridSize + 2, bounds.y + args.gridSize + 9 * args.gridSize - 14);
        context.fillText('p2', bounds.x + 9 * args.gridSize - 16, bounds.y + args.gridSize - 14);
        context.fillText('p3', bounds.x + 9 * args.gridSize - 16, bounds.y + args.gridSize + 9 * args.gridSize - 14);
    }
}
