...
export default class NorExample extends Circuit {
  ...
  readonly norNeither: CompoundNorGate<number>
  readonly norIn1: CompoundNorGate<number>
  readonly norIn2: CompoundNorGate<number>
  readonly norBoth: CompoundNorGate<number>
