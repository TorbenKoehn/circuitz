...
export default class DemuxExample extends Circuit {
  ...
  readonly demux0: CompoundDemux<number>
  readonly demux1: CompoundDemux<number>
  readonly demux2: CompoundDemux<number>
  readonly demux3: CompoundDemux<number>
  readonly out0: Receiver<number>
  readonly out1: Receiver<number>
  readonly out2: Receiver<number>
  readonly out3: Receiver<number>
  readonly out4: Receiver<number>
  readonly out5: Receiver<number>
  readonly out6: Receiver<number>
  readonly out7: Receiver<number>
